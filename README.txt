...
Cold AI 3rd has hardly changed any original unit.

This AI does not guarantee compatibility with any other mods, maps, or missions. The author guarantees that this AI does not contain any code that damages the computer system, , and the author is not responsible for any consequences arising from the use of this AI.
...
*Terrain Types fix, UI fix, buildngz fix, Washington Monument shadow fix @雷德克里莫

*Grizzly Battle Tank, Rhino Heavy Tank fix @比那名居天子

*CAWASH06 shadow fix @4StarGeneral
